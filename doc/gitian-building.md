...
[blockchaingate/gitian.sigs](https://github.com/blockchaingate/gitian.sigs/) repository, or if that's not possible create a pull
request. You can also mail the files to Jordan Earls (earlz@fabcoins.info) and he will commit them.