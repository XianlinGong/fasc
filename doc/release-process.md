...
space *do not upload these to the fabcoins.info server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the fabcoins.info server
...
people without access to `fabcoins.info` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
fabcoins.info (see below for fabcoins.info update instructions).

- Update fabcoins.info version

  - First, check to see if the Fabcoin.org maintainers have prepared a
    release: https://github.com/fabcoin-dot-org/fabcoins.info/labels/Releases
  ...
  - If they have not prepared a release, follow the Fabcoin.org release
    instructions: https://github.com/fabcoin-dot-org/fabcoins.info#release-notes
