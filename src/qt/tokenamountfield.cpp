...
public:
    ...
    void fixup(QString &input) const
    {
        ...
        if(valid)
        {
            input = FabcoinUnits::formatToken(decimalUnits, val, false, FabcoinUnits::separatorAlways);
    ...
    void setValue(const int256_t& value)
    {
        ...
        lineEdit()->setText(FabcoinUnits::formatToken(decimalUnits, val, false, FabcoinUnits::separatorAlways));
        Q_EMIT valueChanged();
    }
...
private:
    ...
    {
        int256_t val = 0;
        bool valid = FabcoinUnits::parseToken(decimalUnits, text, &val);
        if(valid)
        {
