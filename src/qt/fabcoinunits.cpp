...
QString FabcoinUnits::longName(int unit)
{
    switch(unit)
    {
...
QString FabcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uFAB: return QString::fromUtf8("bits");
...
QString FabcoinUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+FabcoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
