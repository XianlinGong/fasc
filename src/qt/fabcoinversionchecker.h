#ifndef FABCOINVERSIONCHECKER_H
#define FABCOINVERSIONCHECKER_H

#include <QObject>

#define FABCOIN_RELEASES "https://github.com/blockchaingate/fabcoin/releases"
...
class FabcoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit FabcoinVersionChecker(QObject *parent = 0);
