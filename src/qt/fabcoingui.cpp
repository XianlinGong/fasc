...
#include <qt/fabcoinversionchecker.h>
...
void FabcoinGUI::createActions()
{
    ...
    QRCTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/qrctoken"), tr("&FRC Tokens"), this);
    QRCTokenAction->setStatusTip(tr("FRC Tokens (send, receive or add Tokens in list)"));
    ...
    openAction->setStatusTip(tr("Open a fabcoin: URI or payment request"));//FABCOIN_LINE
    ...
    menu(0)
{
    ...
    {
        max_width = qMax(max_width, fm.width(FabcoinUnits::longName(unit)));
    }
...
void UnitDisplayStatusBarControl::createContextMenu()
{
    ...
    {
        QAction *menuAction = new QAction(QString(FabcoinUnits::longName(u)), this);
...
{
    setText(FabcoinUnits::longName(newUnits));
}
