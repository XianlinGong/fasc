...
void TestGUI()
{
    ...
    QString balanceComparison = FabcoinUnits::formatWithUnit(unit, balance, false, FabcoinUnits::separatorAlways);
    ...
    // Amount input
    FabcoinAmountField* amountInput = receiveCoinsDialog.findChild<FabcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: fabcoin:")) != -1);
