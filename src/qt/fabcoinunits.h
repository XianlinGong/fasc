...
/** Fabcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FabcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FabcoinUnits(QObject *parent);

    /** Fabcoin units.
      @note Source: https://en.fabcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FAB,
...
typedef FabcoinUnits::Unit FabcoinUnit;

#endif // FABCOIN_QT_FABCOINUNITS_H
