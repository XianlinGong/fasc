...
QString TokenTransactionTableModel::formatTxAmount(const TokenTransactionRecord *wtx, bool showUnconfirmed, FabcoinUnits::SeparatorStyle separators) const
{
    QString str = FabcoinUnits::formatToken(wtx->decimals, wtx->credit + wtx->debit, false, separators);
    if(showUnconfirmed)
    {
...
QString TokenTransactionTableModel::formatTxAmountWithUnit(const TokenTransactionRecord *wtx, bool showUnconfirmed, FabcoinUnits::SeparatorStyle separators) const
{
    QString unit = QString::fromStdString(wtx->tokenSymbol);
    QString str = FabcoinUnits::formatTokenWithUnit(unit, wtx->decimals, wtx->credit + wtx->debit, false, separators);
    return QString(str);
}
...
QVariant TokenTransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, FabcoinUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, FabcoinUnits::separatorNever));
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, FabcoinUnits::separatorNever);
    case FormattedAmountWithUnitRole:
        return formatTxAmountWithUnit(rec, false, FabcoinUnits::separatorAlways);
    case StatusRole:
