...
////////////////////////////////////////////////////////////// // fabcoin
	void setFabcoinSchedule(EVMSchedule _fabcoinSchedule) const { fabcoinSchedule = _fabcoinSchedule; }

	EVMSchedule& getFabcoinSchedule() const { return fabcoinSchedule; }
...
private:
	...
	mutable EVMSchedule fabcoinSchedule; // fabcoin
