...
#include "genesis/fabcoinMainNetwork.cpp"
#include "genesis/fabcoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::fabcoinMainNetwork: return c_genesisInfoFabcoinMainNetwork;
	case Network::fabcoinTestNetwork: return c_genesisInfoFabcoinTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::fabcoinMainNetwork: return c_genesisStateRootFabcoinMainNetwork;
	case Network::fabcoinTestNetwork: return c_genesisStateRootFabcoinTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
