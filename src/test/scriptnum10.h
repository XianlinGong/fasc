...
#ifndef FABCOIN_TEST_SCRIPTNUM10_H
#define FABCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fabcoin Core 0.10.0, for cross-comparison.
 */
public:
