...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    auto ver = stream.GetVersion();
    stream.SetVersion(ver | SERIALIZE_BLOCK_NO_CONTRACT);
    stream >> block;
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
    ...
    CDataStream merkleStream(SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_BLOCK_LEGACY |SERIALIZE_BLOCK_NO_CONTRACT);
