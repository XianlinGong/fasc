...
{
    BOOST_CHECK(TestSplitHost("www.fabcoins.info", "www.fabcoins.info", -1));
    BOOST_CHECK(TestSplitHost("[www.fabcoins.info]", "www.fabcoins.info", -1));
    BOOST_CHECK(TestSplitHost("www.fabcoins.info:80", "www.fabcoins.info", 80));
    BOOST_CHECK(TestSplitHost("[www.fabcoins.info]:80", "www.fabcoins.info", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8665", "127.0.0.1", 8665));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8665", "127.0.0.1", 8665));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8665", "::ffff:127.0.0.1", 8665));
    BOOST_CHECK(TestSplitHost("[::]:8665", "::", 8665));
    BOOST_CHECK(TestSplitHost("::8665", "::8665", -1));
    BOOST_CHECK(TestSplitHost(":8665", "", 8665));
    BOOST_CHECK(TestSplitHost("[]:8665", "", 8665));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8665", "127.0.0.1:8665"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8665", "[::]:8665"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
