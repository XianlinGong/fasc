...
{
    const char* pszTimestamp = "Sep 02, 2017 Fabcoin breaks $5,000 in latest price frenzy";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("fabcoin3.dynu.net"); // Fabcoin mainnet
        vSeeds.emplace_back("fabcoin5.dynu.net"); // Fabcoin mainnet
        vSeeds.emplace_back("fabcoin6.dynu.net"); // Fabcoin mainnet
        vSeeds.emplace_back("fabcoin7.dynu.net"); // Fabcoin mainnet
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("fabcoin4.dynu.net"); // Fabcoin testnet
