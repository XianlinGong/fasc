...
VERSION=
commit=false
url=https://github.com/blockchaingate/fabcoin
ethurl=https://github.com/blockchaingate/cpp-eth-fabcoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/blockchaingate/fabcoin
