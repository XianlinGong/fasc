...
BASE_SCRIPTS= [
    ...
    'fabcoin_opcall.py',
    'fabcoin_opcreate.py',
    'fabcoin_8mb_block.py',
    'fabcoin_gas_limit.py',
    'fabcoin_searchlog.py',
    #'fabcoin_pos_segwit.py',
    'fabcoin_state_root.py',
    'fabcoin_evm_globals.py',
    'fabcoin_null_sender.py',
    'fabcoin_waitforlogs.py',
    'fabcoin_block_header.py',
    'fabcoin_callcontract.py',
    'fabcoin_spend_op_call.py',
    'fabcoin_condensing_txs.py',
    'fabcoin_createcontract.py',
    'fabcoin_sendtocontract.py',
    'fabcoin_identical_refunds.py',
    'fabcoin_create_eth_op_code.py',
    'fabcoin_gas_limit_overflow.py',
    'fabcoin_call_empty_contract.py',
    'fabcoin_dgp_block_size_sync.py',
    #'fabcoin_pos_conflicting_txs.py',
    'fabcoin_globals_state_changer.py',
    'fabcoin_no_exec_call_disabled.py',
    'fabcoin_soft_block_gas_limits.py',
    'fabcoin_dgp_block_size_restart.py',
    'fabcoin_searchlog_restart_node.py',
    #'fabcoin_immature_coinstake_spend.py',
    'fabcoin_transaction_prioritization.py',
    #'fabcoin_assign_mpos_fees_to_gas_refund.py',
    #'fabcoin_ignore_mpos_participant_reward.py',
    'fabcoin_many_value_refunds_from_same_tx.py',
    'fabcoin_combined_outputs_exceed_gas_limit.py',
    'fabcoin_dgp_gas_price_lingering_mempool_tx.py',
]
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("(example|feature|interface|mempool|mining|p2p|rpc|wallet|fabcoin)_")
