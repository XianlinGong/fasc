...
# TestNode: A peer we use to send messages to fabcoind, and store responses.
...
class CompactBlocksTest(FabcoinTestFramework):
    ...
    # Test that fabcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for fabcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # fabcoind will not send blocktxn responses for blocks whose height is
